...
public class Search_frag_grid_adapter extends RecyclerView.Adapter<Search_frag_grid_adapter.MyViewHolder> {
    ...
    public Search_frag_grid_adapter(Context c, ArrayList<Product_details> productDetailsList) {
        this.c = c;
    ...
    @Override
    public Search_frag_grid_adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.new_products_details, parent, false);

        Search_frag_grid_adapter.MyViewHolder myViewHolder = new Search_frag_grid_adapter.MyViewHolder(view);
        return myViewHolder;
    }

    @Override
    public void onBindViewHolder(Search_frag_grid_adapter.MyViewHolder holder, int position) {
