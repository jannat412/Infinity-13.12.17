...
public class BestSellerProductDetailsAdapter extends RecyclerView.Adapter<BestSellerProductDetailsAdapter.MyViewHolder> {
...
//    ImageLoader imageLoader = Server_request.getInstance().getImageLoader();
    ...
    public BestSellerProductDetailsAdapter(Context c, ArrayList<Product_details> data) {
        this.c = c;
        this.product_details = data;
    }

    public BestSellerProductDetailsAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                                   int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.new_products_details, parent, false);

        BestSellerProductDetailsAdapter.MyViewHolder myViewHolder = new BestSellerProductDetailsAdapter.MyViewHolder(view);
        return myViewHolder;
    }

    @Override
    public void onBindViewHolder(BestSellerProductDetailsAdapter.MyViewHolder holder, int position) {
